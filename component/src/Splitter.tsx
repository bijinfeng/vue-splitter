import { defineComponent, computed, ref, useTemplateRef, Fragment, h, type VNode, SlotsType } from "vue";
import { useResizeObserver } from '@vueuse/core'

import { splitterProps, type PanelProps } from "./interface"
...
export const Splitter = defineComponent({
  name: "Splitter",
  props: splitterProps(),
  slots: Object as SlotsType<{ "start-collapse-bar": any, "end-collapse-bar": any }>,
  setup(props, { slots }) {
    ...
    return () => (
      <div ref="container" class={[prefixCls, `${prefixCls}-${props.layout}`]}>
          ...
          if (resizableInfo) {
            ...
            splitBar = (
              <SplitBar
                ...
                v-slots={{
                  'start-collapse-bar': slots['start-collapse-bar'],
                  'end-collapse-bar': slots['end-collapse-bar']
                }}
              />
            )
          }
